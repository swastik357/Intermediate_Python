...
class AttributeFilter:
    ...
    def __init__(self, op, value):
        """init."""
        """Construct a new `AttributeFilter` from."
        "an binary predicate and a reference value.
...
class DateFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return approach.time converted to date.

        for the date filter.
        Args:
            approach (CloseApproach): a CloseApproach object.
        Returns:
            [date]:  datetime converted to date.
        """
...
class DistanceFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return distance of the CloseApproach object.
...
class DiameterFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return the diameter of the neo assigned to the CloseApproach object.

        for the diameter filter.
        Args:
            approach (CloseApproach): a CloseApproach object.
        Returns:
...
class HazardousFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return the hazardous attribute of the neo assigned to the.

        CloseApproach object for the diameter filter.
        Args:
            approach (CloseApproach): a CloseApproach object.
        Returns:
            [float]: returns the hazardous attribute"
            "of a NearEarthObject object.
        """
...
def create_filters(date=None, start_date=None, end_date=None,
    ...
    Each of these arguments is provided"
    "by the main module with a value from the
    ...
    The return value must be compatible"
    "with the `query` method of `NEODatabase`
